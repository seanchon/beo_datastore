...
def filter_dataframe(dataframe, said, export, column_list=[]):
    ...
    return dataframe[dataframe["SA_ID"] == said][column_list]
...
def get_dataframe_saids(dataframe):
    return set(dataframe["SA_ID"])


def get_rate_plan(dataframe, said):
    rate_plan = dataframe[dataframe["SA_ID"] == said]["RS"].iloc[0]
